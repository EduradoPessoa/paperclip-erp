...
|---|---|
| Multitenancy real e segurança (secrets, keys, grants) | **Fase 1 ✅**: manifesto de módulos (`erp_modules`) · memória M1 (bindings + operações auditadas) · RBAC base (`erp:<módulo>:<ação>`) · **entidades mestras** (clientes, fornecedores, produtos, plano de contas) |
