...
|---|---|
| Multitenancy real e segurança (secrets, keys, grants) | **Fase 1 ✅**: manifesto de módulos (`erp_modules`) · memória M1 · RBAC base · entidades mestras · Financeiro base · **Compras ✅** (pedido de compra com aprovação humana via pipeline + recebimento fiscal → contas a pagar) |
